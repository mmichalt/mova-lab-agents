...
Detailed configuration, contracts, operations, and verification notes for
[mova-lab-agents](../README.md).
...
measure 8192 context and a larger `num_predict`, then update this reference and
...
- [Architecture and learning plan](architecture-plan.md)
